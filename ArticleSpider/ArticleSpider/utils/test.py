...
# https://video.bttbo.com/20221101/ZDlkMGY1Mz/224901/1280/hls/encrypt/index.m3u8?_=1684642197136
...
# https://video.bttbo.com/20221101/ZDlkMGY1Mz/224901/1280/hls/encrypt/ZDlkMGY1Mz0.ts
def main():
    # response = askURL(url='https://video.bttbo.com/20221101/ZDlkMGY1Mz/224901/1280/hls/encrypt/index.m3u8?_=1684642197136')
    url = 'https://vod1.ttbfp2.com/20220425/F3gLYlTN/2000kb/hls/index.m3u8'
    sub_ts = url.split('/20220425')[0]
    # print(sub_ts)
    response = requests.get(url=url)
    ...
    for ts in ts_list:
        ...
        open('1.mp4',mode='ab').write(ts_data)

# audioAndVideo(r'C:\Users\A\Desktop\VideoClawer\BiliBiliClawer\python教程.mp3',
#               r'C:\Users\A\Desktop\VideoClawer\BiliBiliClawer\python教程.mp4')
